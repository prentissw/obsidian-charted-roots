...
| 📋 Medium | [**Reports & Print Export**](https://github.com/banisterious/obsidian-canvas-roots/wiki/Roadmap#reports--print-export) | Family Group Sheets, Ahnentafel reports, character sheets, evidence matrices |
