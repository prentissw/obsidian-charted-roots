...
export class ControlCenterModal extends Modal {
	...
	private showPeopleTab(): void {
		renderPeopleTab({
			...
			previewRemoveDuplicateRelationships: () => this.previewRemoveDuplicateRelationships(),
			removeDuplicateRelationships: () => { void this.removeDuplicateRelationships(); },
			previewRemovePlaceholders: () => this.previewRemovePlaceholders(),
			removePlaceholders: () => { void this.removePlaceholders(); },
			previewAddPersonType: () => this.previewAddPersonType(),
			addPersonType: () => { void this.addPersonType(); },
			previewNormalizeNames: () => this.previewNormalizeNames(),
			normalizeNames: () => { void this.normalizeNames(); },
			previewFixBidirectionalRelationships: () => { void this.previewFixBidirectionalRelationships(); },
			fixBidirectionalRelationships: () => { void this.fixBidirectionalRelationships(); },
			previewValidateDates: () => this.previewValidateDates(),
			validateDates: () => this.validateDates(),
			previewDetectImpossibleDates: () => this.previewDetectImpossibleDates()
		});
	}
